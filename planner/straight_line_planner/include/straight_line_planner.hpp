...
class StraightLinePlanner : public plugin_base_classes::PathPlanner
{
public:
...
PLUGINLIB_EXPORT_CLASS(planner_plugins::StraightLinePlanner, plugin_base_classes::PathPlanner)
